...
### Authors' Comments
We worked on both the items and the "highlighted" details can be found as follows:
...
| l1037: "The K verifier takes a minute to verify the sum-to-n" -> a minute sounds a lot for such a simple program!| We clarified our take on this scalability issue. | Section 5.2 &#10148; footnote 16 at Last line |
| **Reviewer A: Qs to Authors** |      | |
| have you tried bigger examples than the ones presented here? how well does/would the work scale to bigger examples?| We clarified  take on scalability issue. | Section 5.2 &#10148; footnote 16 at Last line |
...
| ACL proof assistant" --> "ACL2 proof assistant" (the "2" is part of the name; it's not a version number)|Corrected| Section 1 &#10148; First paragraph |
| "may sound a daunting" --> "may sound like a daunting"|Corrected| Section 1 &#10148; Last paragraph|
...
| the absence of exception modeling, how does your model apply to invalid programs, such as those with addressing or alignment issues?| Clarified |Section 7 &#10148; Exceptions|
| Is alignment considered in memory instructions?| Clarified |Section 3.3 &#10148; Memory State &#10148; footnote 3 in first paragraph|
