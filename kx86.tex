...
\SC{\s{nextloc}}    \footnote{\label{nextloc}\SC{For brevity, the cell \s{nextloc} is omitted from the program configuration (described in Figure~\ref{fig:config}). It is used to hold the next memory location to store an instruction.} } cell. Subsequently,
