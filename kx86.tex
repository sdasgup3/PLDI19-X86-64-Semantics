...
\noindent\textbf{\emph{Register State}}
...
\noindent\textbf{\emph{Memory State}}
...
\vspace{2pt}
\noindent\textbf{\emph{Read from Source Operand(s)}}
...
\vspace{2pt}
\noindent\textbf{\emph{Operate on Data}}
...
\vspace{2pt}
\noindent\textbf{\emph{Write to Destination Operand(s)}}
...
\vspace{2pt}
\noindent\textbf{\emph{Systematic Translation of \Strata Rules to K}}
%
...
\vspace{2pt}
\noindent\textbf{\emph{Status Flags}}
%
...
\vspace{2pt}
\noindent\textbf{\emph{Instruction Variants}}
%
...
\vspace{2pt}
\noindent\textbf{\emph{Immediate Instruction Variants}}
%
...
\vspace{2pt}
\noindent\textbf{\emph{Formula Simplification}}
%
...
%
For example, the original \Strata-provided formula for \instr{shrxl \%edx, \%ecx, \%ebx} consists of 8971\cmt{2560} terms (including the operator symbols), but we could simplify it to a formula consisting of only 7 terms.
