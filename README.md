...
| l790: this is the first time we have a reference for the GCC torture tests but it has been mentioned multiple times before. I would have like to see the reference earlier.| Added the missing citation reference | Section 3.2 &#10148; Last but one paragraph |
| l817: "a large fraction (81%) of which 817 is also supported by Strata." -> the distinction and relationship between Strata and Stroke is not explained well.| Clarified the distinction |Section 4.2 &#10148; footnote 13 at first line |
| l1037: "The K verifier takes a minute to verify the sum-to-n" -> a minute sounds a lot for such a simple program!| We clarified our take on this scalability issue. | Section 5.2 &#10148;  footnote 15 at last line of the section |
| **Reviewer A: Qs to Authors** |      | |
| have you tried bigger examples than the ones presented here? how well does/would the work scale to bigger examples?| We clarified our take on scalability issue. | Section 5.2 &#10148;  footnote 15 at last line of he section |
