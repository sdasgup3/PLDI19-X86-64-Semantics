...
and greater scalability (in terms of execution lengths) than the RTL analyses \Comment{I don't know what "better design perspective" meant? Also, greater scalability seems like a big advantage, right?}
