...
Employing multiple frameworks enable us to scale to completeness, faithfulness and applicability to formal analysis using exclusive features to formalize (for example, using user-friendly specification syntax, out-of-the-box formal analysis tools) and validate (by using testing infrastructure) the semantics.
