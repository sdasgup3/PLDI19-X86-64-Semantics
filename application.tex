...
<memstate>...
  ...
  49 (*$\mapsto$*) (byte(1,_) => byte(1, 32'0))
  50 (*$\mapsto$*) (byte(2,_) => byte(2, 32'0))
  51 (*$\mapsto$*) (byte(3,_) => byte(3, 32'0))
  // -4(%rbp): s
  52 (*$\mapsto$*) (byte(0,_) => byte(0, (32'(N * (N + 1)) / 2)))
  53 (*$\mapsto$*) (byte(1,_) => byte(1, (32'(N * (N + 1)) / 2)))
  54 (*$\mapsto$*) (byte(2,_) => byte(2, (32'(N * (N + 1)) / 2)))
  55 (*$\mapsto$*) (byte(3,_) => byte(3, (32'(N * (N + 1)) / 2)))
...</memstate>
  requires N (*$\ge$*) 0 and N < 2^31
       and (N * (N + 1)) / 2 < 2^31
\end{lstlisting}
\vspace{-5pt}
\begin{center}
