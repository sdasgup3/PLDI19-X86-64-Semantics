...
\Comment{Say what is the benefit of the non-determinism strategy: why did we pick it if it has this disadvantage?}
%
...
\Comment{I don't see much added information in the following paragraph: all of this is either obvious or repeats info above.  (In contrast, the info above about using multiple frameworks is awesome and should be even more interesting to readers.). What do we lose if we drop this para?}
%
